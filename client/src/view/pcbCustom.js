...
const NaturalBeautyCream = () => {
    return (
        <div style={{ backgroundColor: '#b4d2ed', height: '90vh', margin: 0, padding: 0 }}>
            <Container
                sx={{
                    display: 'flex',
                    flexDirection: 'column',  // Atur konten dalam kolom
                    justifyContent: 'center',
                    alignItems: 'center',
                    height: '90vh',
                    bgcolor: '#b4d2ed', // Ubah warna background menjadi #b4d2ed
                    textAlign: 'center'  // Tambahkan untuk menengahkan teks header
                }}
            >
                {/* Header Section */}
                <Typography
